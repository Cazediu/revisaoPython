...
def media_campo(dados, campo): #calcula media (coringa)
...
def filtro_artistas_menos_pop_antes_2016(dados):
    ...
    #ordena a lista do menor pro maior, usa função lambda para atribuir os valores de pop e organiza-los
...
def gerar_relatorio(dados):
    ...
    conteudo += f"Nome do dataset: top10s.csv"
    conteudo += f"Descrição: Dataset com músicas populares do Spotify entre 2010 e 2019."
